...
import {customRef, defineComponent, reactive, ref, toRef, watch} from 'vue';
...
import {type QuestionAddRequest, QuestionControllerService} from "@/generated";
...
const onsubmit = () => {
  QuestionControllerService.addQuestion(question);
...
let question = reactive<QuestionAddRequest>({
  title: '',
  content: '',
  tags: [],
  answer: '',
   ...
   <a-layout class="layout-demo">
     ...
     <a-layout>
       <a-layout-header style="padding-left: 20px;">
         ...
         <a-button type="primary"  @click="onsubmit" style="float: right; margin: 8px 48px">
           提交
         </a-button>
       </a-layout-header>
           ...
           <a-row style="margin-bottom: 48px" >
             <a-col :span="24">
               ...
               <a-row>
                 ...
                 <a-col :span="5">
                   <a-slider v-model="question.judgeConfig.timeLimit" :style="{ width: '300px' }" show-input :max="1000"/>
                 </a-col>
                 <a-col :span="2" style="margin: auto; text-align: center">
                   <a-tag color="blue">内存(kb)</a-tag>
                 </a-col>
                 <a-col :span="5">
                   <a-slider v-model="question.judgeConfig.memoryLimit" :style="{ width: '300px' }" show-input :max="1000"/>
                 </a-col>
                 <a-col :span="2" style="margin: auto; text-align: center">
                   <a-tag color="blue">堆栈(kb)</a-tag>
                 </a-col>
                 <a-col :span="5">
                   <a-slider v-model="question.judgeConfig.stackLimit" :style="{ width: '300px' }" show-input :max="1000"/>
                 </a-col>
               </a-row>
             ...
             <a-col :span="24">
               ...
               <a-row>
                 ...
                 <a-col :span="4" >
                   ...
                   <a-button style="margin: 0 16px" type="secondary" size="mini"  @click="()=>{question.judgeCase = []}">清空所有</a-button>
                 </a-col>
               </a-row>
             </a-col>
           </a-row>
           <a-table :columns="[{title: '输入', dataIndex: 'input'}, {title: '输出', dataIndex: 'output'},{title: '操作',slotName:'button'}]" :data="question.judgeCase">
             <template #button="{ record }">
                <a-button type="dashed" size="mini" @click="() => {question.judgeCase.splice(question.judgeCase.indexOf(record), 1)}">删除</a-button>
             </template>
            </a-table>
         </a-layout-content>
